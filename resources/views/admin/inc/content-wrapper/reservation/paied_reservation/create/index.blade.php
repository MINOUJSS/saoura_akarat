<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        حجز مدفوع
        <small>حجز مدفوع لمدة أسبوعين</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">حجز مدفوع</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <section class="invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
              <i class="fa fa-globe"></i> حجز عقار بعربون لمدة  أسبوعين.
        ...
        <div class="row">
          ...
          <!-- form start -->
        <form role="form" action="{{route('admin.paied.reservation.store')}}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            <h3>
              سيتم حجز هذا العقار لصالح : {{  $order_to_find_r_e->name }}. بعربون لمدة أسبوعين إبتداءا من اليوم {{date('d-m-Y H:i:s')}} إلى غاية {{ $After2Week }}
            </h3>
          </div>
