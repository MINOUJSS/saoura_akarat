<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        إضافة عملية
        <small>إضافة عملية البيع أوالكراء أو التبادل للعقارات</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">إضافة عملية</li>
      </ol>
    </section>
        ...
        <form role="form" action="{{route('admin.operation.store')}}" method="POST" enctype="multipart/form-data">
          ...
          @if($reale_estate->transaction=='للكراء')
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="exp_date" name="exp_date" placeholder="تاريخ نهاية عقد الكراء">
          </div><!-- /.box-body -->
          @endif
          <div class="box-body">
            <div class="form-group">
              <label for="tax">مستحقات الموقع</label>
              <input type="number" class="form-control" id="tax" name="tax" placeholder="أدخل مستحقات الموقع">
          </div><!-- /.box-body -->
