            ...
            <div class="row">
              ...
              @endif
                <div class="col-md-6 col-md-offset-3 col-sm6-6 col-sm-offset-3 ">
                    <form id="r_e_form" class="form-inline" role="form" action="{{route('site-store-real-estate')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <h4 style="color:#ffffff">2)- معلومات عقارك</h4>
